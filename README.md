...
書く前に見出しの骨組み（スケルトン）を固め、[12箇条の文体憲法](./skills/natural-japanese/references/writing-constitution.md)を制約として適用します。「結論から書く」「同じ型を繰り返さない」といったルールで縛り、最初から歪みの少ない文章を出力させます。
